      ...
      <div class="container">
        ...
        <div class="col-12 bi-padding">
            ...
            <div class="row justify-content-center">
                <a target="_blank" href="https://bioimageit.github.io/bioimageit_gui/tutorial_data_management.html" class="bi-tile-link">
                <div class="col-sm bi-tile">
                    <img class="img-hover" src="~@/assets/icons/tutorial_icon_white.png" alt="tutorial" width="150px">
                    <p>Data management</p>
                </div>
                </a>
                <a target="_blank" href="https://bioimageit.github.io/bioimageit_gui/tutorial_data_analysis.html" class="bi-tile-link">
                <div class="col-sm bi-tile">
                    <img class="img-hover" src="~@/assets/icons/tutorial_icon_white.png" alt="tutorial" width="150px">
                    <p>Data analysis</p>
                </div>
        ...
        <div class="col-12 bi-padding">
            ...
            <div class="row justify-content-center">
                <a target="_blank" href="https://github.com/bioimageit/bioimageit-notebooks/blob/main/tutorial1-experiment.ipynb" class="bi-tile-link">
                <div class="col-sm bi-tile">
                    <img class="img-hover" src="~@/assets/icons/tutorial_icon_white.png" alt="tutorial" width="150px">
        ...
        <div class="col-12 bi-padding">
            ...
            <div class="row justify-content-center">
                <a target="_blank" href="https://bioimageit.github.io/bioimageit_core/tutorial_wrap_a_tool.html" class="bi-tile-link">
                <div class="col-sm bi-tile">
                    <img class="img-hover" src="~@/assets/icons/tutorial_icon_white.png" alt="tutorial" width="150px">
                    <p>Write a tool wraper</p>
                </div>
                </a>
                <a target="_blank" href="https://bioimageit.github.io/bioimageit_core/tutorial_write_a_data_plugin.html" class="bi-tile-link">
                <div class="col-sm bi-tile">
                    <img class="img-hover" src="~@/assets/icons/tutorial_icon_white.png" alt="tutorial" width="150px">
                    <p>Write a data plugin</p>
                </div>
                </a>
                <a target="_blank" href="https://bioimageit.github.io/bioimageit_core/tutorial_write_a_runner_plugin.html" class="bi-tile-link">
                <div class="col-sm bi-tile">
                    <img class="img-hover" src="~@/assets/icons/tutorial_icon_white.png" alt="tutorial" width="150px">
...
.bi-tile:hover {
    ...
    box-shadow: 25px 25px 65px #343a40, -25px -25px 65px #343a40;
