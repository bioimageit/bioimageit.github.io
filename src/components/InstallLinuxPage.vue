...
<div>
  ...
  <h1>Linux install</h1>
      ...
      <p><code><br />
        cd /home/$USER && wget  https://raw.githubusercontent.com/bioimageit/bioimageit-install/v0.1.1/linux/install.sh && chmod +x install.sh && sh install.sh && rm install.sh<br />
      </code></p>
